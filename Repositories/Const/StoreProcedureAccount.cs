...
namespace Repositories.Const
{
    public class StoreProcedureAccount
    {
        public static readonly string UspLogin = "UpsUserLogin";
        public static readonly string UpsRegistration = "UpsRegistration";
        public static readonly string UspForgetPassword = "UspForgetPassword";
